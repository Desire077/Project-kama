...
export default function Acheter() {
  ...
  const loadOffers = async () => {
    ...
    try {
      // Load offers for sale (type: maison, appartement, terrain)
      const params = {
        status: 'online',
  ...
  return (
    <div className="min-h-screen bg-bg-light py-8">
      <div className="container mx-auto px-4">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-text-primary mb-2">Acheter un bien</h1>
          <p className="text-text-secondary">Trouvez la propriété parfaite pour vous</p>
        </div>
          ...
          <>
            {offers.length === 0 ? (
              <div className="premium-card p-12 text-center shadow-lg">
                ...
                <p className="text-text-secondary mb-4">Nous n'avons pas encore de biens à vendre. Revenez bientôt !</p>
                <Link 
                  to="/offers" 
