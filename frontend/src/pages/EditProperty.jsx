  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-[#1A3C40]"></div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white py-8">
      <div className="container mx-auto px-4">
        <div className="mb-8">
          <Link to={`/offers/${id}`} className="text-[#1A3C40] hover:text-[#00BFA6] flex items-center mb-4">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between">
            ...
            <div className="mt-4 md:mt-0">
              <button 
                ...
                disabled={submitting}
                className="bg-gradient-to-r from-[#1A3C40] to-[#00BFA6] text-white px-6 py-3 rounded-lg font-bold hover:from-[#0D2A2D] hover:to-[#00A08A] transition shadow-lg flex items-center disabled:opacity-50"
              >
                {submitting ? (
                  <>
          ...
          <form onSubmit={handleSubmit} className="p-6">
            ...
            <div className="mb-6">
              ...
              <input
                ...
                className="block w-full text-sm text-gray-500
                  ...
                  file:bg-[#1A3C40] file:text-white
                  hover:file:bg-[#0D2A2D]"
              />
            </div>
            ...
            <div className="border-b border-gray-200 pb-6 mb-6">
              <h2 className="text-xl font-bold text-gray-900 mb-4 flex items-center">
                <i className="fas fa-info-circle text-[#1A3C40] mr-2"></i> Informations de base
              </h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="md:col-span-2">
                  ...
                  <input
                    ...
                    required
                    className="w-full border border-gray-300 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-[#1A3C40]"
            ...
            <div className="border-b border-gray-200 pb-6 mb-6">
              <h2 className="text-xl font-bold text-gray-900 mb-4 flex items-center">
                <i className="fas fa-door-open text-[#1A3C40] mr-2"></i> Pièces et aménagements
              </h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
                <div className="flex items-center p-4 border border-gray-200 rounded-lg">
                  <input
                    ...
                    onChange={handleChange}
                    className="h-5 w-5 text-[#1A3C40] rounded focus:ring-[#1A3C40]"
                  />
                  <label className="ml-3 block text-sm font-medium text-gray-700">
                    <i className="fas fa-umbrella-beach text-[#00BFA6] mr-2"></i> Terrasse
                  </label>
                </div>
                ...
                <div className="flex items-center p-4 border border-gray-200 rounded-lg">
                  ...
                  />
                  <label className="ml-3 block text-sm font-medium text-gray-700">
                    <i className="fas fa-swimming-pool text-[#00BFA6] mr-2"></i> Piscine
                  </label>
                </div>
                ...
                <div className="flex items-center p-4 border border-gray-200 rounded-lg">
                  ...
                  />
                  <label className="ml-3 block text-sm font-medium text-gray-700">
                    <i className="fas fa-parking text-[#00BFA6] mr-2"></i> Parking
                  </label>
                </div>
              </div>
            </div>
            ...
            <div className="border-b border-gray-200 pb-6 mb-6">
              <h2 className="text-xl font-bold text-gray-900 mb-4 flex items-center">
                <i className="fas fa-map-marker-alt text-[#1A3C40] mr-2"></i> Adresse
              </h2>
            ...
            <div className="flex justify-end space-x-4">
              ...
              <button
                type="submit"
                disabled={submitting}
                className="px-6 py-3 bg-gradient-to-r from-[#1A3C40] to-[#00BFA6] text-white rounded-lg font-bold hover:from-[#0D2A2D] hover:to-[#00A08A] disabled:opacity-50 shadow-lg flex items-center"
              >
                {submitting ? (
                  <>
                    <i className="fas fa-spinner fa-spin mr-2"></i> Mise à jour en cours...
