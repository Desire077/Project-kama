  ...
  return (
    <div className="min-h-screen bg-bg-light py-8">
      <div className="container mx-auto px-4">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-text-primary mb-2">Biens de vacances</h1>
          <p className="text-text-secondary">Trouvez votre destination de rêve</p>
        </div>
          ...
          <>
            {offers.length === 0 ? (
              <div className="premium-card p-12 text-center shadow-lg">
                ...
                <p className="text-text-secondary mb-4">Nous n'avons pas encore de biens de vacances. Revenez bientôt !</p>
                <Link 
                  to="/offers" 
